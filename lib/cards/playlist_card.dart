                                ...
                                TextButton(
                                    onPressed: () async{
                                      FirebaseFirestore.instance.collection('youtube').doc('user').update({
                                        'playlist': FieldValue.arrayRemove([{'videoId': widget.videoId, 'videoTitle':widget.videoTitle,'videoThumbnail':widget.videoThumbnail,'profilePic':widget.profile,'channelName':widget.channelName}]),
                                      });
                                    },
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            SizedBox(width: 15,),
                                            Text("Remove form watch playlist",style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.w500,letterSpacing: -0.2),),
                                          ],
                                        ),
                                      ),
                                    )
